...
int main() {
  ...
  cout << "Small pizzas sold: " << small / total * 100 << "%" << endl;
  cout << "Medium pizzas sold: " << medium / total * 100 << "%" << endl;
  cout << "Large pizzas sold: " << large / total * 100 << "%" << endl;
  cout << "Family pizzas sold: " << family / total * 100 << "%" << endl;
